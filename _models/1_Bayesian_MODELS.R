...
#Final model outputs ----
  #Richness models
  #Functional groups
  MOD_S_env.FE <- readRDS(here("Models output","ACTIVE_1","0_Enviromental","Richness","MOD_S_env_V2_May.Rds"))
MOD_S_1_run_TRANSIENT_null <- readRDS(here("Models output","ACTIVE_1","Transient","Richness","MOD_S_1_run_TRANSIENT_null_V2_May.Rds"))
MOD_S_1_run_TRANSIENT <- readRDS(here("Models output","ACTIVE_1","Transient","Richness","MOD_S_1_run_TRANSIENT_V2_May.Rds"))
MOD_S_2_run_TRANSIENT <- readRDS(here("Models output","ACTIVE_1","Transient","Richness","MOD_S_2_run_TRANSIENT_V2_May.Rds"))
MOD_S_3_run_TRANSIENT <- readRDS(here("Models output","ACTIVE_1","Transient","Richness","MOD_S_3_run_TRANSIENT_V2_May.Rds"))
MOD_S_4_run_TRANSIENT <- readRDS(here("Models output","ACTIVE_1","Transient","Richness","MOD_S_4_run_TRANSIENT_V2_May.Rds"))

MOD_S_1_run_CRYPTIC_null <- readRDS(here("Models output","ACTIVE_1","CRYPTIC","Richness","MOD_S_1_run_CRYPTIC_null_V2_May.Rds"))
MOD_S_1_run_CRYPTIC <- readRDS(here("Models output","ACTIVE_1","CRYPTIC","Richness","MOD_S_1_run_CRYPTIC_V2_May.Rds"))
MOD_S_2_run_CRYPTIC <- readRDS(here("Models output","ACTIVE_1","CRYPTIC","Richness","MOD_S_2_run_CRYPTIC_V2_May.Rds"))
MOD_S_3_run_CRYPTIC <- readRDS(here("Models output","ACTIVE_1","CRYPTIC","Richness","MOD_S_3_run_CRYPTIC_V2_May.Rds"))
MOD_S_4_run_CRYPTIC <- readRDS(here("Models output","ACTIVE_1","CRYPTIC","Richness","MOD_S_4_run_CRYPTIC_V2_May.Rds"))

MOD_S_1_run_RESID_null <- readRDS(here("Models output","ACTIVE_1","Resident","Richness","MOD_S_1_run_RESID_null_V2_May.Rds"))
MOD_S_1_run_RESID <- readRDS(here("Models output","ACTIVE_1","Resident","Richness","MOD_S_1_run_RESID_V2_May.Rds"))
MOD_S_2_run_RESID <- readRDS(here("Models output","ACTIVE_1","resident","Richness","MOD_S_2_run_RESID_V2_May.Rds"))
MOD_S_3_run_RESID <- readRDS(here("Models output","ACTIVE_1","Resident","Richness","MOD_S_3_run_RESID_V2_May.Rds"))
MOD_S_4_run_RESID <- readRDS(here("Models output","ACTIVE_1","Resident","Richness","MOD_S_4_run_RESID_V2_May.Rds"))

MOD_S_1_run_PARENTAL_null <- readRDS(here("Models output","ACTIVE_1","PARENTAL","Richness","MOD_S_1_run_PARENTAL_null_V2_May.Rds"))
MOD_S_1_run_PARENTAL <- readRDS(here("Models output","ACTIVE_1","PARENTAL","Richness","MOD_S_1_run_PARENTAL_V2_May.Rds"))
MOD_S_2_run_PARENTAL <- readRDS(here("Models output","ACTIVE_1","PARENTAL","Richness","MOD_S_2_run_PARENTAL_V2_May.Rds"))
MOD_S_3_run_PARENTAL <- readRDS(here("Models output","ACTIVE_1","PARENTAL","Richness","MOD_S_3_run_PARENTAL_V2_May.Rds"))
MOD_S_4_run_PARENTAL <- readRDS(here("Models output","ACTIVE_1","PARENTAL","Richness","MOD_S_4_run_PARENTAL_V2_May.Rds"))


#BIOMASS models
MOD_B_env.FE <- readRDS(here("Models output","ACTIVE_1","0_Enviromental","Biomass","MOD_B_env_V2_May.Rds"))

MOD_BIOM_1_run_TRANSIENT.null <- readRDS(here("Models output","ACTIVE_1","Transient","Biomass","MOD_BIOM_1_run_TRANSIENT_null_V2.May.Rds"))
MOD_BIOM_1_run_TRANSIENT <- readRDS(here("Models output","ACTIVE_1","Transient","Biomass","MOD_BIOM_1_run_TRANSIENT_V2_May.Rds"))
MOD_BIOM_2_run_TRANSIENT <- readRDS(here("Models output","ACTIVE_1","Transient","Biomass","MOD_BIOM_2_run_TRANSIENT_V2_May.Rds"))
MOD_BIOM_3_run_TRANSIENT <- readRDS(here("Models output","ACTIVE_1","Transient","Biomass","MOD_BIOM_3_run_TRANSIENT_V2_May.Rds"))

MOD_BIOM_1_run_CRYPTIC.null <- readRDS(here("Models output","ACTIVE_1","CRYPTIC","Biomass","MOD_BIOM_1_run_CRYPTIC_null_V2.May.Rds"))
MOD_BIOM_1_run_CRYPTIC <- readRDS(here("Models output","ACTIVE_1","CRYPTIC","Biomass","MOD_BIOM_1_run_CRYPTIC_V2_May.Rds"))
MOD_BIOM_2_run_CRYPTIC <- readRDS(here("Models output","ACTIVE_1","CRYPTIC","Biomass","MOD_BIOM_2_run_CRYPTIC_V2_May.Rds"))
MOD_BIOM_3_run_CRYPTIC <- readRDS(here("Models output","ACTIVE_1","CRYPTIC","Biomass","MOD_BIOM_3_run_CRYPTIC_V2_May.Rds"))

MOD_BIOM_1_run_RESID.null <- readRDS(here("Models output","ACTIVE_1","Resident","Biomass","MOD_BIOM_1_run_RESID_null_V2.May.Rds"))
MOD_BIOM_1_run_RESID <- readRDS(here("Models output","ACTIVE_1","Resident","Biomass","MOD_BIOM_1_run_RESID_V2_May.Rds"))
MOD_BIOM_2_run_RESID <- readRDS(here("Models output","ACTIVE_1","resident","Biomass","MOD_BIOM_2_run_RESID_V2_May.Rds"))
MOD_BIOM_3_run_RESID <- readRDS(here("Models output","ACTIVE_1","Resident","Biomass","MOD_BIOM_3_run_RESID_V2_May.Rds"))

MOD_BIOM_1_run_PARENTAL.null <- readRDS(here("Models output","ACTIVE_1","PARENTAL","Biomass","MOD_BIOM_1_run_PARENTAL_null_V2.May.Rds"))
MOD_BIOM_1_run_PARENTAL <- readRDS(here("Models output","ACTIVE_1","PARENTAL","Biomass","MOD_BIOM_1_run_PARENTAL_V2_May.Rds"))
MOD_BIOM_2_run_PARENTAL <- readRDS(here("Models output","ACTIVE_1","PARENTAL","Biomass","MOD_BIOM_2_run_PARENTAL_V2_May.Rds"))
MOD_BIOM_3_run_PARENTAL <- readRDS(here("Models output","ACTIVE_1","PARENTAL","Biomass","MOD_BIOM_3_run_PARENTAL_V2_May.Rds"))

#GLOBAL
MOD_S_env <- readRDS(here("Models output","GLOBAL","0_Enviromental","Richness","MOD_S_env_V2_May.Rds"))
#Active 1 (pare5, cryptic5,resid15,transi15)
MOD_S_1_run_ACTIVE.1_null <- readRDS(here("Models output","GLOBAL","ACTIVE 1","Richness","MOD_S_1_run_ACTIVE.1_null_V2_Jun.Rds"))
MOD_S_1_run_ACTIVE.1 <- readRDS(here("Models output","GLOBAL","ACTIVE 1","Richness","MOD_S_1_run_ACTIVE.1_V2_May.Rds"))
MOD_S_2_run_ACTIVE.1 <- readRDS(here("Models output","GLOBAL","ACTIVE 1","Richness","MOD_S_2_run_ACTIVE.1_V2_May.Rds"))
MOD_S_3_run_ACTIVE.1 <- readRDS(here("Models output","GLOBAL","ACTIVE 1","Richness","MOD_S_3_run_ACTIVE.1_V2_May.Rds"))
MOD_S_4_run_ACTIVE.1 <- readRDS(here("Models output","GLOBAL","ACTIVE 1","Richness","MOD_S_4_run_ACTIVE.1_V2_May.Rds"))

#Active 2 (pare15, cryptic15,resid25,transi25)
MOD_S_1_run_ACTIVE.2_null <- readRDS(here("Models output","GLOBAL","ACTIVE 2","Richness","MOD_S_1_run_ACTIVE.2_null_V2_Jun.Rds"))
MOD_S_1_run_ACTIVE.2 <- readRDS(here("Models output","GLOBAL","ACTIVE 2","Richness","MOD_S_1_run_ACTIVE.2_V2_May.Rds"))
MOD_S_2_run_ACTIVE.2 <- readRDS(here("Models output","GLOBAL","ACTIVE 2","Richness","MOD_S_2_run_ACTIVE.2_V2_May.Rds"))
MOD_S_3_run_ACTIVE.2 <- readRDS(here("Models output","GLOBAL","ACTIVE 2","Richness","MOD_S_3_run_ACTIVE.2_V2_May.Rds"))
MOD_S_4_run_ACTIVE.2 <- readRDS(here("Models output","GLOBAL","ACTIVE 2","Richness","MOD_S_4_run_ACTIVE.2_V2_May.Rds"))

#Passive (no larval behaviour)
MOD_S_1_run_PASSIVE_null <- readRDS(here("Models output","GLOBAL","PASSIVE","Richness","MOD_S_1_run_PASSIVE_null_V2_Jun.Rds"))
MOD_S_1_run_PASSIVE <- readRDS(here("Models output","GLOBAL","PASSIVE","Richness","MOD_S_1_run_PASSIVE_V2_May.Rds"))
MOD_S_2_run_PASSIVE <- readRDS(here("Models output","GLOBAL","PASSIVE","Richness","MOD_S_2_run_PASSIVE_V2_May.Rds"))
MOD_S_3_run_PASSIVE <- readRDS(here("Models output","GLOBAL","PASSIVE","Richness","MOD_S_3_run_PASSIVE_V2_May.Rds"))
MOD_S_4_run_PASSIVE <- readRDS(here("Models output","GLOBAL","PASSIVE","Richness","MOD_S_4_run_PASSIVE_V2_May.Rds"))

#BIOMASS models
MOD_B_env <- readRDS(here("Models output","GLOBAL","0_Enviromental","Biomass","MOD_B_env_V2.Rds"))
#Active 1 (pare5, cryptic5,resid15,transi15)
MOD_BIOM_1_run_ACTIVE.1.null <- readRDS(here("Models output","GLOBAL","ACTIVE 1","Biomass","MOD_BIOM_1_run_ACTIVE.1_null_V2.May.Rds"))
MOD_BIOM_1_run_ACTIVE.1 <- readRDS(here("Models output","GLOBAL","ACTIVE 1","Biomass","MOD_BIOM_1_run_ACTIVE.1_V2_May.Rds"))
MOD_BIOM_2_run_ACTIVE.1 <- readRDS(here("Models output","GLOBAL","ACTIVE 1","Biomass","MOD_BIOM_2_run_ACTIVE.1_V2_May.Rds"))
MOD_BIOM_3_run_ACTIVE.1 <- readRDS(here("Models output","GLOBAL","ACTIVE 1","Biomass","MOD_BIOM_3_run_ACTIVE.1_V2_May.Rds"))

#Active 2 (pare15, cryptic15,resid25,transi25) -
MOD_BIOM_1_run_ACTIVE.2 <- readRDS(here("Models output","GLOBAL","ACTIVE 2","Biomass","MOD_BIOM_1_run_ACTIVE.2_V2_May.Rds"))
MOD_BIOM_2_run_ACTIVE.2 <- readRDS(here("Models output","GLOBAL","ACTIVE 2","Biomass","MOD_BIOM_2_run_ACTIVE.2_V2_May.Rds"))
MOD_BIOM_3_run_ACTIVE.2 <- readRDS(here("Models output","GLOBAL","ACTIVE 2","Biomass","MOD_BIOM_3_run_ACTIVE.2_V2_May.Rds"))

#Passive (no larval behaviour - passive) -
MOD_BIOM_1_run_PASSIVE <- readRDS(here("Models output","GLOBAL","PASSIVE","Biomass","MOD_BIOM_1_run_PASSIVE_V2_May.Rds"))
MOD_BIOM_2_run_PASSIVE <- readRDS(here("Models output","GLOBAL","PASSIVE","Biomass","MOD_BIOM_2_run_PASSIVE_V2_May.Rds"))
MOD_BIOM_3_run_PASSIVE <- readRDS(here("Models output","GLOBAL","PASSIVE","Biomass","MOD_BIOM_3_run_PASSIVE_V2_May.Rds"))
